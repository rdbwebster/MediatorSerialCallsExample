...
<?oracle-xsl-mapper
  ...
  <mapSources>
    <source type="WSDL">
      ...
      <rootElement name="getDepartmentDetailsResponse" namespace="http://departmentdetailsservice/"/>
    </source>
    <source type="WSDL">
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.5.0(build 110406.1400.11) AT [TUE MAY 01 17:45:46 EDT 2012]. -->
?>
<xsl:stylesheet version="1.0"
                ...
                exclude-result-prefixes="xsi xsl inp1 soap wsdl tns xsd ns0 ns1 plt jca xp20 bpws bpel bpm ora socket mhdr oraext dvm hwf med ids xdk xref bpmn ldap">
